...
export default function Header() {
  return (
    <header className="bg-[url('../../src/assets/img/umkm.jpg')] bg-no-repeat w-full h-screen bg-cover bg-center bg-blend-screen">
      <div className='w-full h-screen bg-white/30 absolute top-0 left-0'>
        <Navbar/>
        <div className="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div className="mx-auto max-w-3xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="text-center">
              ...
              <p className="mt-8 text-xl md:text-2xl md:leading-10 leading-8 text-gray-800">
                <span className=''>
